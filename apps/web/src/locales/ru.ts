export const ru = {
  ...
  module: {
      ...
      wires: [
        {
          ...
          coordinatorLines: [
            'Если 3 провода и есть красный — режь синий.',
            'Если 3 провода без красного — режь последний.'
          ],
          actions: [
        ...
        {
          label: 'Провода B',
          sapperLines: ['На панели 3 провода.', 'Слева направо: белый, черный, красный.'],
          coordinatorLines: [
            'Если последний красный — режь последний.',
            'Если последний не красный — режь первый.'
          ],
          actions: [
            { action: 'cut-wire', label: 'Резать белый', value: '0' },
            { action: 'cut-wire', label: 'Резать черный', value: '1' },
    ...
    parsing: {
      ...
      diskHoursWord: 'часов',
      togglesPositionPrefix: 'Положение',
      togglesUpWord: 'вверх',
      blueHint: 'син',
      redHint: 'крас',
    }
